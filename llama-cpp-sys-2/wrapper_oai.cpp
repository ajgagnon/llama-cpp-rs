...
extern "C" llama_rs_status llama_rs_apply_chat_template_with_tools_oaicompat(
    ...
    try {
        ...
        out_result->thinking_forced_open = params.supports_thinking;
...
extern "C" llama_rs_status llama_rs_apply_chat_template_oaicompat(
    ...
    try {
        ...
        out_result->thinking_forced_open = params_out.supports_thinking;
...
extern "C" llama_rs_status llama_rs_chat_parse_to_oaicompat(
    ...
    *out_json = nullptr;
    ...
    try {
        ...
        (void)thinking_forced_open; // deprecated in llama.cpp; retained for ABI compatibility
